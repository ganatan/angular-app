...
export class CountriesFormComponent extends PageFormComponent {
  ...
  override setFormValue(item: any): void {
    ...
    this.form.controls['isoAlpha2'] = item.isoAlpha2;
    this.form.controls['isoAlpha3'] = item.isoAlpha3;
    this.form.controls['isoNumeric'] = item.isoNumeric;
    this.form.controls['flag'] = item.flag;
