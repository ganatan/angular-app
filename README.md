...
* Frontend - [**Angular 13.3.2**](https://github.com/angular/angular/releases) & [**Angular CLI 13.3.2**](https://github.com/angular/angular-cli/releases/)
