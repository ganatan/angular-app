...
* Frontend - [**Angular 11.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 11.1.2**](https://github.com/angular/angular-cli/releases/)
