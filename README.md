...
* Frontend - [**Angular 14.2.9**](https://github.com/angular/angular/releases) & [**Angular CLI 14.2.8**](https://github.com/angular/angular-cli/releases/)
