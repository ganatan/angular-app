...
* Frontend - [**Angular 15.2.3**](https://github.com/angular/angular/releases) & [**Angular CLI 15.2.4**](https://github.com/angular/angular-cli/releases/)
