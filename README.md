...
* Frontend - [**Angular 16.2.8**](https://github.com/angular/angular/releases) & [**Angular CLI 16.2.5**](https://github.com/angular/angular-cli/releases/)
