...
* Frontend - [**Angular 14.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 14.1.1**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 14.1.1
- [x] Angular CLI : 14.1.1
- [x] Angular Universal : 14.0.3
- [x] Bootstrap : 5.2.0
- [x] Fontawesome : 6.1.1
