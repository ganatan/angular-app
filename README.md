...
* Frontend - [**Angular 17.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 17.1.1**](https://github.com/angular/angular-cli/releases/)
