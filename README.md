...
* Frontend - [**Angular 16.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 16.1.0**](https://github.com/angular/angular-cli/releases/)
