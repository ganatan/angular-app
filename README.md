...
* Frontend - [**Angular 16.0.4**](https://github.com/angular/angular/releases) & [**Angular CLI 16.0.4**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 16.0.4
- [x] Angular CLI : 16.0.4
- [x] Angular Universal : 16.0.2
- [x] Bootstrap : 5.3.0
- [x] Fontawesome : 6.4.0
