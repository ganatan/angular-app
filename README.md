...
* Frontend - [**Angular 11.0.5**](https://github.com/angular/angular/releases) & [**Angular CLI 11.0.5**](https://github.com/angular/angular-cli/releases/)
