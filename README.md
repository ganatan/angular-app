...
* Frontend - [**Angular 16.0.4**](https://github.com/angular/angular/releases) & [**Angular CLI 16.0.5**](https://github.com/angular/angular-cli/releases/)
