...
* Frontend - [**Angular 17.3.4**](https://github.com/angular/angular/releases) & [**Angular CLI 17.3.4**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 17.3.4
- [x] Angular CLI : 17.3.4
- [x] Angular SSR : 17.3.4
- [x] Bootstrap : 5.3.3
- [x] Fontawesome : 6.4.2
