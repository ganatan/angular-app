...
* Frontend - [**Angular 13.3.5**](https://github.com/angular/angular/releases) & [**Angular CLI 13.3.4**](https://github.com/angular/angular-cli/releases/)
