...
* Frontend - [**Angular 17.2.4**](https://github.com/angular/angular/releases) & [**Angular CLI 17.2.3**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 17.2.4
- [x] Angular CLI : 17.2.3
- [x] Angular SSR : 17.2.3
- [x] Bootstrap : 5.3.3
- [x] Fontawesome : 6.4.2
