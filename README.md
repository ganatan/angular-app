...
* Frontend - [**Angular 16.2.4**](https://github.com/angular/angular/releases) & [**Angular CLI 16.2.2**](https://github.com/angular/angular-cli/releases/)
