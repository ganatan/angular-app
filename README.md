...
* Frontend - [**Angular 14.2.1**](https://github.com/angular/angular/releases) & [**Angular CLI 14.2.2**](https://github.com/angular/angular-cli/releases/)
