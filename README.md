...
* Frontend - [**Angular 14.0.5**](https://github.com/angular/angular/releases) & [**Angular CLI 14.0.5**](https://github.com/angular/angular-cli/releases/)
