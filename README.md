...
* Frontend - [**Angular 15.1.0**](https://github.com/angular/angular/releases) & [**Angular CLI 15.1.0**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 15.1.0
- [x] Angular CLI : 15.1.0
- [x] Angular Universal : 15.0.0
- [x] Bootstrap : 5.2.3
- [x] Fontawesome : 6.2.1
