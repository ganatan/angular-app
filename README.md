...
* Frontend - [**Angular 18.0.2**](https://github.com/angular/angular/releases) & [**Angular CLI 18.0.3**](https://github.com/angular/angular-cli/releases/)
