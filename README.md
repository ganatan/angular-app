...
* Frontend - [**Angular 15.2.8**](https://github.com/angular/angular/releases) & [**Angular CLI 15.2.6**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 15.2.8
- [x] Angular CLI : 15.2.6
- [x] Angular Universal : 15.2.1
- [x] Bootstrap : 5.2.3
- [x] Fontawesome : 6.4.0
