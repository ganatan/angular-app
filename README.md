...
* Frontend - [**Angular 13.2.2**](https://github.com/angular/angular/releases) & [**Angular CLI 13.2.3**](https://github.com/angular/angular-cli/releases/)
