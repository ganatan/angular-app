...
* Frontend - [**Angular 16.2.0**](https://github.com/angular/angular/releases) & [**Angular CLI 16.1.8**](https://github.com/angular/angular-cli/releases/)
