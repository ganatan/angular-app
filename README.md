...
* Frontend - [**Angular 15.0.3**](https://github.com/angular/angular/releases) & [**Angular CLI 15.0.3**](https://github.com/angular/angular-cli/releases/)
