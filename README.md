...
* Frontend - [**Angular 12.2.4**](https://github.com/angular/angular/releases) & [**Angular CLI 12.2.4**](https://github.com/angular/angular-cli/releases/)
