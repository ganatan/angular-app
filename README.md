...
* Frontend - [**Angular 15.1.5**](https://github.com/angular/angular/releases) & [**Angular CLI 15.1.6**](https://github.com/angular/angular-cli/releases/)
