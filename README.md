...
* Frontend - [**Angular 18.2.0**](https://github.com/angular/angular/releases) & [**Angular CLI 18.2.0**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 18.2.0
- [x] Angular CLI : 18.2.0
- [x] Angular SSR : 18.2.0
- [x] Bootstrap : 5.3.3
- [x] Fontawesome : 6.6.0
