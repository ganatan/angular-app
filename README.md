...
* Frontend - [**Angular 15.1.3**](https://github.com/angular/angular/releases) & [**Angular CLI 15.1.5**](https://github.com/angular/angular-cli/releases/)
