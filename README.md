...
* Frontend - [**Angular 13.2.4**](https://github.com/angular/angular/releases) & [**Angular CLI 13.2.5**](https://github.com/angular/angular-cli/releases/)
