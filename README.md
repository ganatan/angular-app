...
* Frontend - [**Angular 13.2.6**](https://github.com/angular/angular/releases) & [**Angular CLI 13.2.6**](https://github.com/angular/angular-cli/releases/)
