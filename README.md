...
* Frontend - [**Angular 14.0.6**](https://github.com/angular/angular/releases) & [**Angular CLI 14.0.6**](https://github.com/angular/angular-cli/releases/)
