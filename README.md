...
* Frontend - [**Angular 15.2.1**](https://github.com/angular/angular/releases) & [**Angular CLI 15.2.1**](https://github.com/angular/angular-cli/releases/)
