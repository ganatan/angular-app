...
* Frontend - [**Angular 15.2.6**](https://github.com/angular/angular/releases) & [**Angular CLI 15.2.5**](https://github.com/angular/angular-cli/releases/)
