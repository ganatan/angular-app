...
* Frontend - [**Angular 14.1.0**](https://github.com/angular/angular/releases) & [**Angular CLI 14.1.0**](https://github.com/angular/angular-cli/releases/)
