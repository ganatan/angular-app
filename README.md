...
* Frontend - [**Angular 12.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 12.1.1**](https://github.com/angular/angular-cli/releases/)
