...
* Frontend - [**Angular 17.0.9**](https://github.com/angular/angular/releases) & [**Angular CLI 17.0.10**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 17.0.9
- [x] Angular CLI : 17.0.10
- [x] Angular SSR : 17.0.10
- [x] Bootstrap : 5.3.2
- [x] Fontawesome : 6.4.2
