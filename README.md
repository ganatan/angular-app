...
* Frontend - [**Angular 11.0.4**](https://github.com/angular/angular/releases) & [**Angular CLI 11.0.4**](https://github.com/angular/angular-cli/releases/)
