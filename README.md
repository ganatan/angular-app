...
* Frontend - [**Angular 16.1.7**](https://github.com/angular/angular/releases) & [**Angular CLI 16.1.6**](https://github.com/angular/angular-cli/releases/)
