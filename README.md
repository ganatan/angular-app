...
* Frontend - [**Angular 18.1.1**](https://github.com/angular/angular/releases) & [**Angular CLI 18.1.1**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 18.1.1
- [x] Angular CLI : 18.1.1
- [x] Angular SSR : 18.1.1
- [x] Bootstrap : 5.3.3
- [x] Fontawesome : 6.4.2
