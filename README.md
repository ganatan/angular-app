...
* Frontend - [**Angular 14.2.4**](https://github.com/angular/angular/releases) & [**Angular CLI 14.2.4**](https://github.com/angular/angular-cli/releases/)
