...
* Frontend - [**Angular 15.0.4**](https://github.com/angular/angular/releases) & [**Angular CLI 15.0.5**](https://github.com/angular/angular-cli/releases/)
