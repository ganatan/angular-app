...
* Frontend - [**Angular 16.0.0**](https://github.com/angular/angular/releases) & [**Angular CLI 16.0.0**](https://github.com/angular/angular-cli/releases/)
