...
* Frontend - [**Angular 16.1.5**](https://github.com/angular/angular/releases) & [**Angular CLI 16.1.4**](https://github.com/angular/angular-cli/releases/)
