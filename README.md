...
* Frontend - [**Angular 16.2.6**](https://github.com/angular/angular/releases) & [**Angular CLI 16.2.3**](https://github.com/angular/angular-cli/releases/)
