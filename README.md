...
* Frontend - [**Angular 12.1.0**](https://github.com/angular/angular/releases) & [**Angular CLI 12.1.0**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 12.1.0
- [x] Angular CLI : 12.1.0
- [x] Angular Universal : 12.0.2
- [x] Bootstrap : 5.0.2
